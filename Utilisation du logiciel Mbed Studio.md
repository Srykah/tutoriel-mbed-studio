...
![écran d'accueil](captures\écran d'accueil.png)
...
![connexion carte](captures\connexion carte.png)
...
![config avec carte ok](captures\config avec carte ok.png)
...
![nouveau projet depuis exemple](captures\nouveau projet depuis exemple.png)
...
![écran d'accueil blinky](captures\écran d'accueil blinky.png)
...
![blinky config](captures\blinky config.png)
...
![clang-tidy checks](captures\clang-tidy checks.png)
...
![switch to shared](captures\switch to shared.png)
...
![shared directory](captures\shared directory.png)
...
![new project shared mbed os](captures\new project shared mbed os.png)
